...
export default function KyllingCurryPage() {
  const recipe = {
    title: "Kylling i Curry",
    subtitle: "Saftig kylling i cremet karry-sauce med ris og ananas",
    description: "En lækker og hurtig asiatisk-inspireret ret med kylling i en cremet karry-sauce.",
    prepTime: "15 min",
    cookTime: "25 min",
    servings: 4,
    ...
    instructions: [
      "Skær kyllingen i tern og steg i olie til de er gyldne.",
      "Tag kyllingen af panden og steg løg og hvidløg.",
      "Tilsæt karry og steg i et minut.",
      "Tilsæt kokosmælk og lad det koge op.",
      "Læg kyllingen tilbage i saucen.",
      "Tilsæt peberfrugt og ananas.",
