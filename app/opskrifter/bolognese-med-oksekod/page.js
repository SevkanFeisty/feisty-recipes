...
export default function BologneseMedOksekodPage() {
  const recipe = {
    title: "Bolognese med Oksekød",
    subtitle: "Klassisk italiensk bolognese med hakket oksekød",
    description: "En velsmagende bolognese sauce med oksekød og tomater.",
    prepTime: "10 min",
    cookTime: "30 min",
    servings: 4,
    ...
    instructions: [
      ...
      "Tilsæt finthakket løg og hvidløg og steg til blødt.",
      "Tilsæt hakkede tomater og lad det simre.",
      "Kog pasta separat.",
      "Server sauce over pasta."
    ]
  };
