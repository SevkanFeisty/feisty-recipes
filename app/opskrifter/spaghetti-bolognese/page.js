...
export default function SpaghettiBolognesePage() {
  const recipe = {
    title: "Spaghetti Bolognese",
    subtitle: "Klassisk spaghetti med bolognese sauce",
    description: "En elsket klassiker med spaghetti og saftig oksekød i tomatsauce.",
    prepTime: "10 min",
    cookTime: "25 min",
    servings: 4,
    image: "https://images.unsplash.com/photo-1622973536968-3ead9e780960?w=1200&h=800&fit=crop",
    ingredients: [
      "400 g spaghetti",
    ...
    instructions: [
      "Kog spaghetti efter anvisning.",
      "Steg oksekød i olie til det er brunet.",
      "Tilsæt løg og hvidløg og steg til blødt.",
      "Tilsæt hakkede tomater og lad det simre.",
      "Server sauce over spaghetti.",
      "Drys med parmesan og persille."
    ]
  };
