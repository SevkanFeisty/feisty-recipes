...
export default function KyllingIKarryPage() {
  const recipe = {
    title: "Kyllingekød i Karry",
    subtitle: "Karryret med kyllingekød, hakkede tomater og kokosmælk",
    description: "En velsmagende og krydret karryret med mørt kyllingekød i en cremet sauce.",
    prepTime: "15 min",
    cookTime: "25 min",
    servings: 4,
    ...
    instructions: [
      "Steg kyllingekød i en pande med olie til det er gyldent.",
      "Tilsæt hakkede tomater og krydderier.",
      "Hæld kokosmælk i og rør rundt.",
      "Lad retten simre i 15-20 minutter.",
