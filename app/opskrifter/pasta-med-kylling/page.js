...
export default function PastaMedKyllingPage() {
  const recipe = {
    title: "Pasta med Kylling og Grønt",
    subtitle: "Pastaret med kylling og friske grøntsager",
    description: "En hurtig og velsmagende pastaret med kylling og grøntsager.",
    prepTime: "10 min",
    cookTime: "20 min",
    servings: 4,
    ...
    instructions: [
      ...
      "Varm kyllingesaucen i en pande.",
      "Skær gulerødder i tern og tilsæt til saucen.",
      "Bland pasta med kyllingesauce.",
