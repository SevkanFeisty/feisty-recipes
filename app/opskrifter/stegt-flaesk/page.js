...
export default function StegtFlaeskPage() {
  const recipe = {
    title: "Stegt Flæsk med Persillesovs",
    subtitle: "Traditionel dansk ret med sprødt flæsk og kartofler",
    description: "Den klassiske danske ret - sprødt stegt flæsk med persillesovs og kogte kartofler.",
    prepTime: "15 min",
    cookTime: "25 min",
    servings: 4,
    image: "https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=1200&h=800&fit=crop",
    ingredients: [
    ...
    instructions: [
      "Tør flæskeskiverne med køkkenrulle og krydre med salt.",
      "Steg flæskeskiverne på en varm pande til de er gyldne og sprøde på begge sider.",
      "Kog kartoflerne i letsaltet vand.",
      "Til persillesovsen: smelt smør i en gryde, rør mel i og tilsæt mælk under omrøring.",
      "Lad sovsen koge op og tykne.",
      "Tilsæt finthakket persille og smag til med muskatnød, salt og peber.",
      "Server flæsket med kartofler og persillesovs."
    ]
  };
