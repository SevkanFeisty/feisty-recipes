...
export default function MorbradgrydePage() {
  const recipe = {
    title: "Mørbradgryde",
    subtitle: "Klassisk dansk mørbrad i cremet sauce med champignoner og bacon",
    description: "En velsmagende og mættende mørbradgryde, perfekt til hverdagsmad med familien.",
    prepTime: "20 min",
    cookTime: "30 min",
    servings: 4,
    ...
    instructions: [
      "Skær mørbaden i tern og brun dem i en pande med olie.",
      "Tag kødet af panden og steg bacon sprødt.",
      "Tilsæt løg og hvidløg og steg til de er bløde.",
      "Tilsæt champignoner og steg i et par minutter.",
      "Drys mel over og rør rundt.",
      "Tilsæt fløde, mælk og opløst bouillonterning.",
      "Læg kødet tilbage og lad det simre i 20 minutter.",
      "Smag til med salt og peber.",
      "Server med pasta eller kartofler og persille."
    ]
  };
