...
export default function KarrySuppePage() {
  const recipe = {
    title: "Karrysuppe",
    subtitle: "Thailandsk inspireret karrysuppe med kokosmælk",
    description: "En varmende og krydret suppe med kokosmælk, grøntsager og din foretrukne protein.",
    prepTime: "15 min",
    cookTime: "20 min",
    servings: 4,
    ...
    instructions: [
      "Skær kylling i tern og peberfrugter i strimler.",
      "Varm olie i en gryde og steg karrypasta i 1 minut.",
      "Tilsæt kokosmælk og bouillon og bring i kog.",
      "Tilsæt kylling og kog i 8 minutter.",
      "Tilsæt peberfrugter, bambusskud, løg og hvidløg.",
      "Lad simre i 5 minutter.",
      "Smag til med fisksauce og lime.",
