...
const recipes = [
  ...
  },
  {
    ...
    description: "En rig og velsmagende kødsauce perfekt til pasta. Langtidssimret med grøntsager og rødvin.",
    category: "Comfort",
    prepTime: "15",
    cookTime: "60",
    servings: 6,
    ...
    ingredients: [
      ...
      { name: "Stangselleri", quantity: "2", unit: "stængler" },
      { name: "Hakkede tomater", quantity: "400", unit: "g" },
    ...
    instructions: [
      "Hak løg, gulerødder og seller fint.",
      "Steg oksekød i en stor gryde indtil brunt.",
      "Tilsæt grøntsager og steg i 5 minutter.",
      "Tilsæt tomatpure og steg i 1 minut.",
      "Hæld rødvin og hakkede tomater i.",
      "Tilsæt oksebouillon og laurbærblade.",
      "Lad det simre i 45-60 minutter.",
  ...
  },
  {
    ...
    subtitle: "Klassisk spaghetti med rig kødsauce",
    description: "En ægte italiensk bolognese med masser af smag. Langtidssimret sauce med oksekød, grøntsager og rødvin.",
    category: "Comfort",
    prepTime: "15",
    cookTime: "45",
    servings: 4,
    ...
    instructions: [
      "Hak løg, gulerødder og seller fint.",
      "Varm olie i en stor gryde og steg grøntsager i 5 minutter.",
      "Tilsæt oksekød og steg indtil brunt.",
      "Tilsæt tomatpure og steg i 1 minut.",
      "Hæld rødvin i og lad det koge ind.",
      "Tilsæt hakkede tomater, oksebouillon og laurbærblade.",
      "Lad sovsen simre i 30-45 minutter.",
      "Kog spaghetti al dente og server med sovsen."
    ]
  },
  // Week 12 recipes
  {
